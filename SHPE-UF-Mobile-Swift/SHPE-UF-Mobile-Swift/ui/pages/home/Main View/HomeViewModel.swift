    ...
    func createDummyEvents() -> [Event] {
            ...
            return [
                Event(
                    ...
                    end: EventDateTime(dateTime: formatter.date(from: "2024-12-25T15:00:00Z")!, timeZone: "UTC"),
                    etag: "123",
                    eventType: "GBM",
                    ...
                    sequence: 0,
                    start: EventDateTime(dateTime: formatter.date(from: "2024-12-25T14:00:00Z")!, timeZone: "UTC"),
                    status: "confirmed",
                    summary: "GBM #1",
                    updated: Date(),
                ...
                Event(
                    ...
                    end: EventDateTime(dateTime: formatter.date(from: "2024-12-31T23:59:00Z")!, timeZone: "UTC"),
                    etag: "456",
                    eventType: "Social",
                    htmlLink: "http://example.com",
                    iCalUID: "event2",
                    ...
                    organizer: Organizer(email: "organizer@example.com", selfValue: 0),
                    sequence: 0,
                    start: EventDateTime(dateTime: formatter.date(from: "2024-12-31T20:00:00Z")!, timeZone: "UTC"),
                    status: "confirmed",
                    summary: "SHPE 2024 Convention",
                    updated: Date(),
                ...
                Event(
                    ...
                    end: EventDateTime(dateTime: formatter.date(from: "2025-01-01T10:00:00Z")!, timeZone: "UTC"),
                    etag: "789",
                    eventType: "Workshop",
                    htmlLink: "http://example.com",
                    iCalUID: "event3",
                    ...
                    organizer: Organizer(email: "organizer@example.com", selfValue: 0),
                    sequence: 0,
                    start: EventDateTime(dateTime: formatter.date(from: "2025-01-01T08:00:00Z")!, timeZone: "UTC"),
                    status: "confirmed",
